        ...
        <div class="col-md-12">
            <div class="error-template">
                <h1>
                    Oops!</h1><br>
                <h2>
                    ${requestScope.errorMsg}</h2><br><br>
                
                <div class="error-details">
                    발생된 문제 : ${requestScope.errorMsg}
                </div>
                <div class="error-actions">
                    <a href="${pageContext.request.contextPath}/web/index.jsp" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-home"></span>
                        Take Me Home </a><a href="javascript:history.back()" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-envelope"></span>뒤로가기</a>
                </div>
            </div>
        </div>
    </div>
