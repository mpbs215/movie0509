				...
				<div class="col-md-12">
					<div class="panel ">
						<div class="panel-body text-center">
							<div id="tabs">
								<ul>
									<li><a href="#tabs-1">현재 상영관 리스트</a></li>
									<li><a href="#tabs-2">상영관 추가하기</a></li>
								</ul>
								<div id="tabs-1" style="overflow-x: auto">
										<table class="table table-hover table-fixed pre-scrollable" id="theaterList">
											...
											<tr style="background-color: #FF8D1B;">
												<th style="color: white">상영관 이름</th>
												<th style="color: white">좌석수</th>
												<th style="color: white">삭제</th>
											</tr>
										</table>
								</div>
								<div id="tabs-2" style="overflow-x: auto">
										<form action="${pageContext.request.contextPath}/admin?command=theaterInsert" method="post">
										<table class="table table-hover table-fixed pre-scrollable"
											id="theaterRegist">
											<tr style="background-color: #FF8D1B;">
												<th style="color: white">상영관 이름</th>
												<th style="color: white">좌석수</th>
												<th style="color: white">등록하기</th>
											</tr>
											<tr>
												<td><input type="text" name="theaterName" required="required"/></td>
												<td><input type="number" name="theaterTotal" required="required"/></td>
